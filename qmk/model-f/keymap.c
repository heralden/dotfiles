...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_hhkb_split_shift_split_backspace(
        ...
        KC_ESC,    KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_TAB,         KC_P4,   KC_P5,   KC_P6,
    ...
    [_FN] = LAYOUT_ansi_hhkb_split_shift_split_backspace(
        ...
        _______,    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                PREV_TAB,  KC_NO,   NEXT_TAB,
